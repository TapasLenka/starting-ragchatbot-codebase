...
class CourseOutlineTool(Tool):
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        return {
            ...
            "description": (
                "Get the complete outline of a course: its title, course link, "
                "and the number and title of every lesson. Use this for outline, "
                "syllabus, or course structure queries."
            ),
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_title": {
                        "type": "string",
                        "description": "Course title to look up (partial matches work, e.g. 'MCP')"
                    }
                },
